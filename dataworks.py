...
fields = ("First name", "Middle name", "Last name", "DoB", "Gender", "Eating", "Hobby", "Phy", "Chem", "Maths", "Phone", "Mail", "Locality", "District", "City", "PO", "PS", "Country", "State", "PIN", "GName", "GRelation", "GOcc", "GPhone", "GMail")
