...
mandatory = ("First name", "Last name", "Gender", "Eating", "Phy", "Chem", "Maths", "Phone","Country",
"State", "City","Locality", "District", "PO", "PS", "PIN", "GName", "GRelation", "GPhone", "GCountry",  "GState", "GCity","GLocality", "GDistrict", "GPO", "GPS" , "GPIN")
...
def validate(suspDict): #TODO: Date of Birth
    ...
    for key in mandatory:
        if suspDict[key] == "":
            invalids.append(key)
        elif key == "Phone" or key == "GPhone" or key == "PIN" or key == "GPIN" or key == "Phy" or key == "Chem" or key == "Maths":
            try:
